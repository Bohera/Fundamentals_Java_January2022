...
public class KaminoFactory_093 {
    public static void main(String[] args) {
        ...
        while (!line.equals("Clone them!")) {
            ...
            if (currentLength > maxLength) {
                ...
                bestDna = data.split("");
            } else if (currentLength == maxLength && (bestDnaPosition > currentPosition || currentSumElement > maxSumElements)) {
                maxLength = currentLength;
                maxSumElements = currentSumElement;
                bestDnaPosition = currentPosition;
                bestCountDna = countDna;
